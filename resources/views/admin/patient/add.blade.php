      ...
      <form method="post" action="{{url('dashboard/patient/submit')}}" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> patient Registration</h4>
                    </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group row mb-3 {{ $errors->has('email') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-7">
                    <input type="text" autocomplete="off" class="form-control form_control" name="email" value="{{old('email')}}">
                    @if ($errors->has('email'))
                        <span class="invalid-feedback" role="alert">
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-md-2">
                <img id="img-upload" src="{{(@$data->patient_photo!='')?asset('uploads/users/'.Auth::user()->patient_photo):asset('uploads/avatar/avatar-black.jpg')}}">
            </div>
        </div>
            </div>
