      ...
      <form method="post" action="{{url('dashboard/service/update')}}" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> edit Service</h4>
                    </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group row mb-3 {{ $errors->has('name') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control form_control" name="name" value="{{$data->service_name}}">
              ...
              <div class="form-group row mb-3 {{ $errors->has('price') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control form_control" name="price" value="{{$data->service_price}}">
                    @if ($errors->has('price'))
                        <span class="invalid-feedback" role="alert">
              ...
              <div class="form-group row mb-3 {{ $errors->has('category_id') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-7">
                    <select class="form-control form_control" name="category_id">
                        ...
                        <option value="{{$cat->category_id}}" {{($data->category_id==$cat->category_id)?'selected':''}}>{{$cat->category_name}}</option>
                        @endforeach
                    </select>
              ...
              <div class="form-group row mb-3">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control form_control" name="remarks" value="{{$data->service_remarks}}">
                  </div>
              </div>
            </div>
