    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> All service Information</h4>
                    </div>
                    <div class="col-md-4 text-right">
                        <a href="{{url('dashboard/service/add')}}" class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i class="fas fa-plus-circle label-icon"></i> Add service</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                      @foreach($all as $data)
                        ...
                        <tr>
                            ...
                            <td>{{Str::words($data->service_remarks,3)}}</td>
                            <td>
                              <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{url('dashboard/service/view/'.$data->service_slug)}}">View</a>
                                    <a class="dropdown-item" href="{{url('dashboard/service/edit/'.$data->service_slug)}}">Edit</a>
                                    <a class="dropdown-item" href="#" id="softDelete" title="delete" data-toggle="modal" data-target="#softDelModal" data-id="{{$data->service_id}}">Delete</a>
                                </div>
                              </div>
                            </td>
                        </tr>
